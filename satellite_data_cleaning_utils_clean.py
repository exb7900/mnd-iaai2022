...
#         if verbose:
#             print('wrt outcomes')
#         overall = np.zeros((1, nB, len(imList)))
#     else:
#         if verbose:
#             print('wrt features')
#         overall = np.zeros((nB, nB, len(imList)))
...
#             overall[feature, loop[1][f], i] = \
#                 correlation(meanImData[:,:,feature], 
#                             meanImData[:,:,loop[1][f]])
        
#         # Fill in full matrix
#         currentIm = overall[:,:,i]
#         i_lower = np.tril_indices(currentIm.shape[0], -1)
#         currentIm[i_lower] = currentIm.T[i_lower]
#         overall[:,:,i] = currentIm
...
#                                               meanOutData)
#     overall = np.nanmean(overall, axis=2)
#     return (overall * -1) + 1
